...
- **AI Agents**:
    ...
    - **Question Engine**: Template-based algorithmic question generator (`server/services/questionEngine/`) for deterministic, parameterised question generation without AI calls. Currently supports Linear Equations, Inequalities (30 archetypes each across 4 difficulty levels, with sign-flip logic for inequalities), Fractional Indices (30 archetypes covering radical conversion, index law application, negative indices, and rationalisation), Introduction to Surds (30 archetypes covering surd identification, simplification, combining like surds, multiplying, expanding brackets, difference of squares, and denominator rationalisation including conjugate method), Simplifying Surds (30 archetypes covering perfect square factor extraction, coefficient simplification, combining like surds after simplification, unlike surd recognition, multi-term expressions, expand-then-simplify, and surd fractions), Operations with Surds (30 archetypes covering addition/subtraction of like surds, multiplication with simplification, simplify-before-combine, expand brackets with FOIL, difference of squares, squaring binomials, product of conjugates, and multi-term mixed expressions), Expanding Binomial Products (30 archetypes across 4 difficulty levels covering monic FOIL, perfect squares, difference of squares, non-monic binomials, triple products, and combined expressions with answers in canonical polynomial form x^2+Bx+C), Perfect Squares and Difference of Squares (30 archetypes across 4 difficulty levels covering perfect square identities (x+a)^2/(x-a)^2, difference of squares (x+a)(x-a), non-monic variants, mixed sign expressions, nested simplification, multi-step combinations, and structural pattern recognition), Gradient and Parallel Lines (30 archetypes across 4 difficulty levels covering gradient from two points, gradient from equation y=mx+c, parallel lines with equal gradients, perpendicular lines in challenge, and visual questions with inline SVG coordinate diagrams), Factorising Common Factors (30 archetypes across 4 difficulty levels covering numerical GCF extraction, variable common factors, monomial factorisation, negative common factors, multi-term expressions, higher powers, and mixed-variable factorisation), Factorising Quadratics (30 archetypes across 4 difficulty levels covering monic trinomials, difference of squares, GCF-then-monic, non-monic AC method, GCF-then-non-monic, rearranged terms, and non-monic difference of squares), Finding Equations of Lines (30 archetypes across 4 difficulty levels covering equation from m and c, equation from two points, point-and-gradient, parallel lines, perpendicular lines, fractional slopes, x/y-intercept pairs, and visual coordinate diagram questions with inline SVG; answers in y=mx+c format with y= prefix stripping for equivalence checking), Simultaneous Equations – Graphical (30 archetypes across 4 difficulty levels covering intersection reading, solution verification, parallel lines (no solution), and coincident lines (infinitely many solutions) with makeTwoLineSvg() visual SVG coordinate graphs; answers as coordinate pairs (x,y), "no solution", or "infinitely many solutions" via normalizeCoordinatePairInput()), Simultaneous Equations – Substitution (30 archetypes across 4 difficulty levels covering y-form substitution, standard form substitution, rearranging before substitution, x-equals expressions, fractional coefficients, negative coefficients, visual verification problems with SVG graphs, and classification problems for parallel/coincident/intersecting lines; answers as coordinate pairs (x,y), "no solution", or "infinitely many solutions"), Trigonometric Ratios (30 archetypes across 4 difficulty levels covering sine/cosine/tangent ratio identification, ratio from lengths, find missing side, find ratio decimal, inverse trigonometric functions, algebraic side expressions, two-step Pythagoras-then-trig, coordinate geometry triangles, special angle exact values (30°/45°/60°), Pythagorean identity verification, and mixed visual reasoning; every question includes custom right-triangle SVG diagrams via makeRightTriangleSvg/makeCoordinateTriangleSvg with color-coded sides and labeled angles), and Finding Unknown Sides in Trigonometry (30 archetypes across 4 difficulty levels covering finding opposite/adjacent/hypotenuse using sin/cos/tan given an angle and one side, integer and decimal answers with rounding, word problems (ladder, ramp, guy wire), algebraic side expressions, multi-step Pythagoras-after-trig, special angle exact values with surds, two triangles sharing a side, coordinate geometry with distance formula, and complex rearrangements; every question includes right-triangle SVG diagrams with "?" for unknown sides), and Finding Unknown Angles (30 archetypes across 4 difficulty levels covering inverse trigonometric functions sin⁻¹/cos⁻¹/tan⁻¹ to find angles from side ratios, special angle recognition, decimal rounding, word problems (angle of elevation/depression), Pythagoras-then-inverse-trig multi-step, algebraic side expressions, coordinate geometry triangles, finding both acute angles, and combined area/perimeter problems; every question includes right-triangle SVG diagrams with "?" for unknown angles), and Trigonometry Applications (30 archetypes across 4 difficulty levels covering angles of elevation/depression, building/tree height problems, shadow length, ladder-wall, kite string, lighthouse-boat, ramp angles, two-observer verification, multi-triangle problems, bearings and navigation, surveying across rivers, area calculations using trig, and real-world optimisation; every question includes application-context SVG diagrams), and Surface Area of Prisms (30 archetypes across 4 difficulty levels covering cube SA, rectangular prisms, triangular prisms with right-triangle and isosceles cross-sections, nets and face counting, word problems, missing dimension problems, trapezoidal and hexagonal prisms, Pythagoras for slant height, composite shapes, unit conversion, equilateral triangle cross-sections with √3, optimisation, algebraic dimensions, and SA-to-volume ratios; every question includes 3D prism SVG diagrams with labeled dimensions). Answer checking uses numeric substitution equivalence via `mathExpressionsEquivalent()` so swapped factor orders like (x+3)(x-2) and (x-2)(x+3) are accepted, and line equations like y=2x+3 vs y = 2x + 3 are matched via y= stripping and numeric evaluation. Integrated into Warm-up and Exit Ticket flows with a "Regenerate" button.
